    ...
    <?php include 'header.php';?>
        ...
        <div class="khung-add-sp">
            ...
            if(isset($_POST["save_product"])){
                ...
                if (empty($selectOption) || empty($name_sp) || empty($motaSP) || empty($giaGoc) || empty($quantity)) {
                ...
                if($tenFile!=""){
                    ...
                    if (!in_array($fileType, array("jpg", "png"))) {
                        ...
                        if (move_uploaded_file($_FILES["file_tai_len"]["tmp_name"], $targetFile)) {
                            ...
                            VALUES ('$ma_sp', '$name_sp', '$motaSP', '$giaGoc', '$giaSale', '$quantity', '$selectOption', '$targetFile')");
