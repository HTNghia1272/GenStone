        ...
        <div class="khung-add-sp">
            ...
            <div class="chung_div">
                <div class="fr_tsp">
                    ...
                    <input type="text" name="ma_sp" id="ma_sp" placeholder="Nhập mã sản phẩm" value="Sp003" readonly><br>
                </div>
            </div>
            <div class="chung_div">
                <div class="fr_tsp">
                    <p>Tên sản phẩm</p> <br>
                    <input type="text" name="name_sp" id="name_sp" placeholder="Nhập tên sản phẩm" value="<?php echo isset($_POST["name_sp"]) ? $_POST["name_sp"] : ''; ?>"><br>
                </div>
            </div>
            ...
            <div class="chung_div">
                <div class="fr_tsp">
                    ...
                    padding-left: 10px; font-size: 16px; font-family: 'Source Sans Pro', sans-serif; padding-top: 10px;"></textarea>
                </div>
            </div>
            ...
            <div class="chung_div">
                <div class="fr_tsp">
                    ...
                    <div class="anh_sanPham" style="width: 50%;">
                        <img src="img_sp/ao-polo-dep-2.jpg" alt="" style="width: 50%; height: 10%;">
                    </div><br>
            ...
            <div class="chung_div">
                <div class="fr_tsp">
                    ...
                    <p>Giá gốc</p>
                     <input type="text" name="giaGoc" id="giaGoc" value="<?php echo isset($_POST["giaGoc"]) ? $_POST["giaGoc"] : ''; ?>"><br><br>
                     <p>Giá sale</p>
                ...
                if($tenFile!=""){
                   ...
                   if (!in_array($fileType, array("jpg", "png"))) {
                        ...
                        if (move_uploaded_file($_FILES["file_tai_len"]["tmp_name"], $targetFile)) {
                            ...
                            Price='$giaGoc',PriceSale= '$giaSale',Quantity ='$quantity',TypeID = '$selectOption',ImgProduct='$targetFile' 
                            ...
                            */
                            ...
                            if($sql_update){
                            echo "<script>alert('Đã UPDATE lại thông tin sản phẩm.')</script>";
                            $name_sp = "";
                            $motaSP  = "";
                            $giaGoc = "";
                            $giaSale = "";
